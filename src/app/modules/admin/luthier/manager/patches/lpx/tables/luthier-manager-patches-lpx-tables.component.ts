...
import {LuthierTableModel, LuthierObjectType} from '../../../../../../../shared/models/luthier.model';
...
export class LuthierManagerPatchesLpxTablesComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges{
    ...
    handleFilter(filterData: FilterModel[]): void {
        ...
        if (!this.import) {
            ...
            this.service.filterTables(filterRequest)
                .then(value => {
