...
@Component({
    selector: 'luthier-manager-patches-lpx-visions',
    templateUrl: './luthier-manager-patches-lpx-visions.component.html',
    styleUrls: ['/luthier-manager-patches-lpx-visions.component.scss'],
...
export class LuthierManagerPatchesLpxVisionsComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges{
    ...
    public datasource = new MatTableDataSource<LuthierVisionModel>();
    displayedColumns: string[] = ['select', 'status', 'code', 'name', 'description'];
    selection = new SelectionModel<LuthierVisionModel>(true, []);
    ...
    ngAfterViewInit(): void {
        ...
        this.datasource.filterPredicate = (data: LuthierVisionModel, filter: string) => {
    ...
    handleFilter(filterData: FilterModel[]): void {
        ...
        if (!this.import) {
            ...
            this.service.filterVisions(filterRequest)
                .then(value => {
