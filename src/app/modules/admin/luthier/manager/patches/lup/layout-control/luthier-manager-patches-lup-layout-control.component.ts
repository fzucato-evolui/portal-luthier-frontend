...
export class LuthierManagerPatchesLupLayoutControlComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges{
    ...
    filters: FilterModel[] = [
        ...
        },
        {
            ...
            operator: 'IN',
            required: false,
            options: Object.keys(LuthierLayoutControlTypeEnum).map((key,index) => ({
                label: key,
                value: index
            }))
        },
    ...
    ngAfterViewInit(): void {
        ...
        this.datasource.filterPredicate = (data: LuthierLayoutControlModel, filter: string) => {
    ...
    handleFilter(filterData: FilterModel[]): void {
        ...
        if (!this.import) {
            ...
            this.service.filterLayoutControls(filterRequest)
                .then(value => {
