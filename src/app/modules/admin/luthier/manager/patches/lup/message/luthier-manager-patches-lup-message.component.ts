...
import {LuthierMessageTypeModel} from '../../../../../../../shared/models/luthier.model';
...
@Component({
    selector: 'luthier-manager-patches-lup-message',
    templateUrl: './luthier-manager-patches-lup-message.component.html',
    styleUrls: ['/luthier-manager-patches-lup-message.component.scss'],
...
export class LuthierManagerPatchesLupMessageComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges{
    ...
    public datasource = new MatTableDataSource<LuthierMessageTypeModel>();
    displayedColumns = ['select', 'statusRow', 'code', 'name'];
    selection = new SelectionModel<LuthierMessageTypeModel>(true, []);
    ...
    ngAfterViewInit(): void {
        ...
        this.datasource.filterPredicate = (data: LuthierMessageTypeModel, filter: string) => {
    ...
    toggleSelection(row: LuthierMessageTypeModel) {
    ...
    handleFilter(filterData: FilterModel[]): void {
        ...
        if (!this.import) {
            ...
            this.service.filterMessageTypes(filterRequest)
                .then(value => {
