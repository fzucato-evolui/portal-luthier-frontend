...
import {LuthierTableHelpModel} from '../../../../../../../shared/models/luthier.model';
...
@Component({
    selector: 'luthier-manager-patches-lup-help',
    templateUrl: './luthier-manager-patches-lup-help.component.html',
    styleUrls: ['/luthier-manager-patches-lup-help.component.scss'],
...
export class LuthierManagerPatchesLupHelpComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges{
    ...
    public datasource = new MatTableDataSource<LuthierTableHelpModel>();
    displayedColumns = ['select', 'statusRow', 'code', 'form', 'value', 'changedAt', 'userModifier.name'];
    selection = new SelectionModel<LuthierTableHelpModel>(true, []);
    ...
    ngAfterViewInit(): void {
        ...
        this.datasource.filterPredicate = (data: LuthierTableHelpModel, filter: string) => {
    ...
    toggleSelection(row: LuthierTableHelpModel) {
    ...
    handleFilter(filterData: FilterModel[]): void {
        ...
        if (!this.import) {
            ...
            this.service.filterTableHelps(filterRequest)
                .then(value => {
