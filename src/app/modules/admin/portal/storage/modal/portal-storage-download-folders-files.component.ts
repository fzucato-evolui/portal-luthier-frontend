...
export interface StorageDownloadFoldersFilesModalData {
    identifierId: number;
    folderId: number;
    folderPath: string;
    folderName: string;
...
@Component({
    selector: 'portal-storage-download-folders-files',
    styleUrls: ['./portal-storage-download-folders-files.component.scss'],
    templateUrl: './portal-storage-download-folders-files.component.html',
    imports: [
        MatIconModule,
        MatButtonModule,
        MatDialogModule,
...
export class PortalStorageDownloadFoldersFilesComponent implements OnInit, OnDestroy {

    data: StorageDownloadFoldersFilesModalData;
    title: string = '';
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<PortalStorageDownloadFoldersFilesComponent>
    ) {}

    ngOnInit(): void {
        this.title = `Download da pasta: ${this.data.folderName || this.data.folderPath}`;

        this.abortFn = this._storageService.downloadFolderFilesAsync(
            this.data.folderId,
