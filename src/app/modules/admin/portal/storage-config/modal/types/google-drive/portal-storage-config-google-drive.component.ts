...
import {GoogleDriveConfig} from '../../../../../../../shared/models/portal-storage-config-types.model';
...
@Component({
    selector: 'portal-storage-config-google-drive',
    templateUrl: './portal-storage-config-google-drive.component.html',
...
export class PortalStorageConfigGoogleDriveComponent implements OnInit {
