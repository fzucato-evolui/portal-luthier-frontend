...
import {GoogleCloudConfig} from '../../../../../../../shared/models/portal-storage-config-types.model';
...
@Component({
    selector: 'portal-storage-config-google-cloud',
    templateUrl: './portal-storage-config-google-cloud.component.html',
...
export class PortalStorageConfigGoogleCloudComponent implements OnInit {
