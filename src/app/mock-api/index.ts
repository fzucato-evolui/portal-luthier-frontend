...
import {AdminPortalLuthierDatabaseMockApi} from './admin/portal/luthier-database/api';
import {AdminLuthierDictionaryMockApi} from './admin/luthier/dictionary/api';

export const mockApiServices = [
    AdminPortalLuthierDatabaseMockApi,
    AdminLuthierDictionaryMockApi,
    AcademyMockApi,
    ActivitiesMockApi,
    AnalyticsMockApi,
    AuthMockApi,
