...
export const appRoutes: Route[] = [
    ...
    {path: '', pathMatch : 'full', redirectTo: 'portal/luthier-database'},
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'portal/luthier-database'},
    ...
    // Auth routes for guests
    {
        ...
        children: [
            ...
            {path: 'login', loadChildren: () => import('app/modules/public/login/login.routes')}
        ]
    },
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'luthier', loadChildren: () => import('app/modules/admin/luthier/luthier.routes')},
            {path: 'portal', loadChildren: () => import('app/modules/admin/portal/portal.routes')},
            // Dashboards
