...
export class CompactLayoutComponent implements OnInit, OnDestroy
{
    ...
    get sercondaryNavigation(): FuseNavigationItem[] {
        return this.navigation.secondary;
    }

    set sercondaryNavigation(value: FuseNavigationItem[]) {
        if (UtilFunctions.isValidStringOrArray(value) === true) {
            value.forEach(x => {
                this._navigationService.setRoles(x);
            })
        }
        this.navigation.secondary = value;
    }
    /**
     * Constructor
     */
